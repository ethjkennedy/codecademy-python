...
for transaction in daily_transactions_split:
    ...
    for item in transaction:
        transactions_item.append(item.replace("\n", "").strip(" "))
    transactions_clean.append(transactions_item)
...
#print(count_colours("white"))

colours = ["white", "blue", "yellow", "purple", "red", "green", "black"]

for colour in colours:
    print("Thread shed only old {0} threads of {1} thread today"
          .format(count_colours(colour), colour))